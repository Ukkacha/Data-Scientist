...
#Le Nombre de journalistes dans le tableau
puts "Combien y a-t-il de journalistes dans ce array ?"
puts journalists.length

#Le Nombre d'handle qui contiennent un numéro
puts "Combien d'handle contiennent un numéro ?"
puts journalists.grep(/[0-9]/).count

#le Nombre d'handle qui contiennent les 4 lettres "Aude" à la suite
...
#Tous ceux qui commencent par une majuscule juste après le @
...
puts "7. Voici la liste de handle par ordre alphabétique: "
...
puts journalists.sort_by { |journalist| journalist.length}[0..49]

#la Position de epenser dans le tableau
